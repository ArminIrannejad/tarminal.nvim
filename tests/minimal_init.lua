...
-- Cut the user's own plugin directories out of both paths. A tarminal
-- installed under site/pack would otherwise win the `require` and the suite
-- would silently test that copy; a site-installed treesitter parser built for
-- a different ABI breaks every ftplugin under an older Neovim. Everything the
-- interpreter ships with stays on the runtimepath.
